...
$msg1.="
	<form name=\"ticket\" method=\"POST\" action\"$action\">
		<table>
			<tr>
				<th>Ticket No. </th>
				<th> <input type=\"text\" name=\"tnumber\" value=\"\"> </th>
				<th> <input type=\"submit\" name=\"submit\" value=\"Confirm >>\"></th>
			</tr>
		</table>
	</form>
	<hr/>
...
*/
  if($tnumber != 0){
		...
		<!--<a href="../admin_booking/printticket/tnumber/<?php echo $row->sales_id; ?>" target="new">Print</a>-->
			<div class="main">
				...
				<?php
					...
					<table class=\"tbl\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" align=\"center\">
						<tr>
							...
							<td width=\"35%\"> $row->ticket_issue_date</td>
						</tr>
						<tr>
