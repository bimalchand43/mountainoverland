...
$msg.="
     <script language=\"JavaScript\">
        ...
        var error=0;
        var errmsg=\"\";
        if(document.forms.changeecpin.fcecpin.value==\"\"){
            document.getElementById(\"jf_cecpin\").innerHTML=\"<font color='red'> Enter Current Password </font>\";
            errmsg+=\"<li>Current Password should not be blank.</li>\";
            error++
        }else{
            document.getElementById(\"jf_cecpin\").innerHTML=\" Enter Current Password \";
        }
     ...
     <form name =\"changeecpin\" method =\"POST\" action=\"$act\" onsubmit=\"return valis();\" style=\" padding:5px;\">
        <div class=\"data\">
            ...
            <tr>
    	          <td colspan=\"2\" class=\"dhdr\"><center><h3>Change Password</h3></center> </td>
            </tr>
            <tr>
            ...
            <tr>
                <td id=\"jf_cecpin\" valign=\"top\" class=\"lebl\">Enter current Password<span style=\"color:red;\">*</span></td>
                <td class=\"inpt\"><input type=\"password\" class=\"text\" name=\"fcecpin\" size=\"30\"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan=\"2\" class=\"dhdr\" align=\"center\"><input type=\"submit\" name=\"submit\" value=\"Confirm>>\" > </td>
            </tr>
           </table>
