...
$msg.="
    ...
    <div id=\"shli\"> 
	      <div>".anchor('admin/comp_profile/view_branch_user/branchuserlist/','Branch User List')."</div>         
          <div>".anchor('admin/comp_profile/view_branch_user/newbranchuser/','Create New User')."</div>
	...
	foreach($query_branch_user as $rows){
	 if($rows->status == 'Y'){
	  ...
	  $msg.="<tr class=\"$rc\">
				...
				<td>$rows->username </td>
				<td align=\"center\">||
                ".anchor('admin/comp_profile/view_branch_user/branchuserlist/viewprofile/'.$rows->aid,'View Profile')." ||
                ".anchor('admin/comp_profile/view_branch_user/branchuserlist/editprofile/'.$rows->aid,'Edit Profile')." ||
                ".anchor('admin/comp_profile/view_branch_user/branchuserlist/chngpass/'.$rows->aid,'Change Password')." ||
                ".anchor('admin/comp_profile/statusFun/branchuserlist/'.$rows->aid.'/'.$rows->status,$stats)."  ||
                </td>
	  ";
